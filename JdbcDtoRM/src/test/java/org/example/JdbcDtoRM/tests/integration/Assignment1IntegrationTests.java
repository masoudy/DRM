...
public class Assignment1IntegrationTests {
    ...
    @Test
    public void firstAssignment_saveAndFindById_UserDto()
    {
        ...
        var retrievedUser = jdbcDRM.findById(101,User.class);
    ...
    @Test
    public void firstAssignment_saveAndFindById_PostDto()
    {
        var post = new Post(1,"url1","caption1");

        jdbcDRM.save(post);
        var retrievedPost = jdbcDRM.findById(1,Post.class);
    ...
    private JdbcDRM jdbcDRM() {
        ...
        return JdbcDRM
                .builder()
                .scanPackageForObjects("org.example.JdbcDtoRM.tests.stuff.assigmnent1")
